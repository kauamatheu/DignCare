...
<head>
    ...
    <title>Altera Serviço - DignCare</title>
...
<body class="fundo">
    ...
    <section class="main-content">
        <form action="../php/altera_servico_bd.php" method="post" class="form-box" id="formulario">
            ...
            <input type="text" name="titulo" id="titulo" placeholder="Altere o título do Serviço">
            ...
            <input type="text" name="valor" id="valor" placeholder="Altere o valor do serviço" inputmode="numeric">
