...
<body class="fundo">
    ...
    <section style="margin: 50px;">
            ...
            <div class="col">
                <div class="card mexe h-100 ">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Cuidar do meu filho Cristiano Ronaldo.
                        </p>
        ...
        <!--Cards Group 2-->
        <div class="row row-cols-1 row-cols-md-6 g-6 espaçamento" style="margin-bottom: 80px;"">
      ...
      <div class=" col">
            <div class="card mexe  h-100">
                ...
                <div class="card-body">
                    <h5 class="card-title">Cuidadora</h5>
